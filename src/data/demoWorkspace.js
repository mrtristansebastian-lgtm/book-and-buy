...
export function createDemoWorkspace() {
  return {
    ...
    website: {
      ...
      homeSubtext:
        'Hands-on classes in a working Cape Town studio. Leave with skill, confidence, and something delicious.',
      profileCategory: 'Cooking classes & culinary studios',
...
export function hydrateDemoWorkspace(stored) {
  ...
  const website = staleWebsite
    ? {
        ...
        venueMode: fresh.website.venueMode,
        locationLat: fresh.website.locationLat,
        locationLng: fresh.website.locationLng,
        countryCode: fresh.website.countryCode,
        region: fresh.website.region,
        city: fresh.website.city,
        servesCountries: fresh.website.servesCountries,
